...
Description: Metadata PE memperlihatkan tanggal tahun 2061, tidak realistis untuk executable saat ini.
Evidence: PEStudio → TimeDateStamp: Sat May 25 2061.
Significance:Timestomping umum digunakan untuk mengaburkan waktu pembuatan sehingga menyulitkan investigasi forensik
...
Percentage
Executive Summary
Memberikan ringkasan singkat mengenai hasil identifikasi malware berdasarkan analisis statis, termasuk risiko dan dampaknya.
[%]
Technical Analysis
Menyusun hasil analisis statis secara detail,
[%]
Evidence Collection
Mengumpulkan artefak berupa hash, screenshot hasil VirusTotal sebagai bukti teknis.
[%]
Timeline
Menyusun urutan tahapan analisis statis dari tahap inisiasi hingga finalisasi.
[%]
IoC List
Menyediakan IoC berbasis hash SHA-256 dan signature packer untuk AgentTesla.
[%]
Recommendations
Memberikan rekomendasi keamanan terkait mitigasi ancaman dari malware infostealer berbasis .NET.
[%]
Presentation Slides
menjelaskan bagian Hasil Analisis Statis dalam presentasi.
[%]
...
9. What I Learned
Technical Knowledge
Pembelajaran mengenai struktur PE32 .NET dan atribut header yang digunakan malware.
Teknik packer & obfuscation, khususnya implementasi UPX pada malware.
Pentingnya Threat Intelligence (VirusTotal) untuk konfirmasi keluarga malware.

Forensic Methodology
Pentingnya tahapan analisis statis sebelum analisis dinamis untuk meminimalkan risiko.
Dokumentasi bukti digital menjadi bagian penting untuk chain of evidence.
Team Collaboration
Pembagian peran yang jelas mempercepat penyelesaian investigasi.
Komunikasi terbuka membuat hasil tiap anggota saling melengkapi.
...
Contribution Level: MediumEffort Level: [1-10]
Quality of Work:8
